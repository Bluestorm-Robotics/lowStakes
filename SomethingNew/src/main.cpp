...
void initialize() {
	pros::lcd::initialize();
	pros::lcd::set_text(1, "Prime Directive = Victory!");
	pros::ADIDigitalOut piston (mogoClamp);
 ...
 */
void autonomous() {}
	ADIDigitalOut goalHolder (mogoClamp);
/**
...
void opcontrol() {
	...
	while (true) {
		/*pros::plcd::print(0, "%d %d %d", (lcd::read_buttons() & LCD_BTN_LEFT) >> 2,
